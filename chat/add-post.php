                        ...
                        <ul class="metismenu" id="menu1">
                            ...
                            <li>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    Alumni</span></a></li>
                                    <li><a title="Add Alumni" href="add-alumni.php"><span class="mini-sub-pro">Add
                                    Alumni</span></a></li>
                                </ul>
                            </li>
                            <li>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div id="content" style="margin-top:10px;height:300%;">
                               <center><h1>Start Group Chat</h1></center>
                               <div class="chat"     style="height: 400px;">
                                <div class="chatbox" style=" border: 1px solid;border-color: #7e8182;border-radius: 10px;width: 1080px; height: 400px;">
                                 <?php
                             ...
                             <!--  <div class="input-group mb-3"     style="padding-top: 320px;"">
                                <p>sabkgasku</p>
                                  <input type="text" class="form-control" placeholder="Type Message" aria-label="Recipient's username" aria-describedby="button-addon2" style="width: 1070px">
                                  <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="submit" id="button-addon2" style="margin: center;margin-left: 510px;">Button</button>
                                  </div>
                                </div> -->
