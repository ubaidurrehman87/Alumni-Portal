...
if (isset($_POST['add-workshop'])) {
    
    $workShop = new workshop();
    
    $workshop_name = mysqli_real_escape_string($connect,$_POST['workshop-name']);
    $speaker = mysqli_real_escape_string($connect,$_POST['speaker']);
    $venue = mysqli_real_escape_string($connect,$_POST['venue']);
    $date = mysqli_real_escape_string($connect,$_POST['date']);
    $time = mysqli_real_escape_string($connect,$_POST['time']);
    $description = mysqli_real_escape_string($connect,$_POST['description']);
    
    $workShop->addWorkshop($workshop_name,$speaker,$venue,$date,$time,$description);
                                ...
                                <div class="row">
                                    ...
                                    <div style="float: right;" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Add Workshop</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Workshop Information</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="add-workshop.php" method="POST" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="workshop-name" id="wName" type="text" class="form-control" required="" placeholder="Name of Workshop">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="speaker" type="text" class="form-control" required="" placeholder="Speaker">
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                        <input name="venue" type="text" class="form-control" required="" placeholder="Venue">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="date" type="date" id="datePickerId" class="form-control" required="" placeholder="Date">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group res-mg-t-15">
                                                                    <div class="form-group">
                                                                        <input name="time"  type="time" class="form-control" required="" placeholder="Date">
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="add-workshop" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="footer footer-copy-right">
                            <p>Copyright � 2018. All rights reserved by <a href="index">Alumni Portal</a></p>
                        </div>
                    </div>
                </div>
            </div>
