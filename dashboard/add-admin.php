...
if (isset($_POST['add-admin'])) {
    ...
    $admins->addadmins($fname,$lname,$dob,$email,$password,$contact,$address);
}
...
<div class="demo"></div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Add Admins</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="add-admin.php" method="POST" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="fname" id="wName" type="text" class="form-control" required="" placeholder="First Name">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="lname" id="wName" type="text" class="form-control" required="" placeholder="Last Name">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="dob" type="date" id="datecheck" onchange="dateChecker(this.value)"  class="form-control" required="" placeholder="Date">
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="contact" maxlength="11" type="text" class="form-control" required="" placeholder="Contact Number">
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="add-admin" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
    ...
    <script type="text/javascript">
      ...
      function dateChecker(date){
        ...
        if (date>2000) { alert('Please Select Reasonable Age!'); 
