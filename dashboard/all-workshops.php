...
<body>
    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Workshops</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <?php $workShop = new workshop(); 
        $workShop->dislpayworkshops(); ?>
        <div style="margin-top: 500px;" class="footer-copyright-area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
