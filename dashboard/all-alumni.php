...
<div class="demo"></div>
    ...
    <div class="all-content-wrapper">
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="../index.php"><span class="edu-icon edu-locked author-log-ic"></span>Log
                                                                Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Alumni</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="card-body">
            <?php if ($_SESSION['ssrole']=='Alumni') {
                echo '<h1 style="font-family: Calibri;text-align: center;color:#006DF0;">Get information About the Alumni of '.$_SESSION['ssuniversity'].' University</h1>';
            } ?>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th>Contact</th>
                  <th>Batch</th>
                  <th <?php if ($_SESSION['ssrole']=='Alumni') {echo "style='visibility:hidden;'";} ?> >Actions</th>
                </tr>
              </thead>
              <tfoot>
                <tr>
              ...
              <tbody>
                <?php $alumni = new alumni(); $alumni->display(); ?>
              </tbody>
            </table>
        </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="footer-copy-right">
                            <p>Copyright � 2018. All rights reserved By Alumni Portal</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function confirm_deletion(id){
        ...
        if (result) {
            window.location = "delete-alumni.php?id="+id;
        }
