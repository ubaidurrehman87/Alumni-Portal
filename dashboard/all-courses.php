...
if (isset($_POST['login_submit'])) {
  ...
  $test=true;
  sleep(2);
  if ($user == "ymaij12@gmail.com" && $pass=="123abc") {
    ...
    <div class="left-sidebar-pro">
            <nav id="sidebar" class="">
                <div class="sidebar-header" style=" height: 60px">
                    <a href="index.php"><img class="main-logo" src="img/logo/favicon.png" alt="" /></a>
                </div>
                ...
                <div class="left-custom-menu-adp-wrap comment-scrollbar">
                    <nav class="sidebar-nav left-sidebar-menu-pro ">
                        <ul class="metismenu" id="menu1">
                            ...
                            <li>
                                <a class="has-arrow" href="all-professors.php" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg"></span>
                                    <span class="mini-click-non">Events</span></a>
                                <ul class="submenu-angle" aria-expanded="false">
                                    <li><a title="All Professors" href="all-events.php"><span class="mini-sub-pro">All
                                                Events</span></a></li>
                                    <li><a title="Add Professor" href="add-event.php"><span class="mini-sub-pro">Add
                                                Event</span></a></li>
                            ...
                            <li>
                                <a class="has-arrow" href="all-professors.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span>
                                    <span class="mini-click-non">Jobs</span></a>
                                <ul class="submenu-angle" aria-expanded="false">
                                    <li><a title="All Professors" href="all-jobs.php"><span class="mini-sub-pro">All
                                                Jobs</span></a></li>
                                    <li><a title="Add Professor" href="add-job.php"><span class="mini-sub-pro">Add
                                                Job</span></a></li>
                            ...
                            <li>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <li><a title="Add Students" href="add-student.php"><span class="mini-sub-pro">Add
                                                Student</span></a></li>
                                    <li><a title="Edit Students" href="edit-student.php"><span class="mini-sub-pro">Edit
                                                Student</span></a></li>
                                    <li><a title="Students Profile" href="student-profile.php"><span class="mini-sub-pro">Student
                                                Profile</span></a></li>
                                </ul>
                            </li>
                            <li>
                                <a class="has-arrow" href="all-courses.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <li><a title="Edit Courses" href="edit-course.php"><span class="mini-sub-pro">Edit
                                                Course</span></a></li>
                                    <li><a title="Courses Profile" href="course-info.php"><span class="mini-sub-pro">Courses
                                                Info</span></a></li>
                            ...
                            <li>
                                <a class="has-arrow" href="mailbox.php" aria-expanded="false"><span class="educate-icon educate-message icon-wrap"></span>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <li><a title="Compose Mail" href="mailbox-compose.php"><span class="mini-sub-pro">Compose
                                                Mail</span></a></li>
                                </ul>
                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="courses-inner res-mg-b-30">
                            <div class="courses-title">
                                <a href="#"><img src="img/courses/app development.jpeg" alt=""></a>
                            ...
                            <div class="product-buttons">
                                <button type="button" class="button-default cart-btn">Start Learning Now</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="courses-inner">
                            <div class="courses-title">
                                <a href="#"><img src="img/courses/illustrator.jpeg" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="courses-inner res-mg-t-30 dk-res-t-pro-30">
                            <div class="courses-title">
                                <a href="#"><img src="img/courses/Web Ddevelopment.jpeg" alt=""></a>
                                <h2>Web Development</h2>
                            </div>
                            <div class="courses-alaltic">
                                <span class="cr-ic-r"><span class="course-icon"><i class="fa fa-clock"></i></span> 1 Year</span>
