    ...
    <div class="all-content-wrapper">
      ...
      <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                ...
                                <li class="active"><a href="#Admins">Admins</a></li>
                                <li   <?php if ($_SESSION['ssrole']=='representative') {
                                    echo "style='visibility:hidden;'";
                                } ?> ><a href="#representative">University Representative</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                               
                                <div class="product-tab-list tab-pane fade active in" id="Admins">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                  <thead>
                                                                    <tr>
                                                                      ...
                                                                      <th>Email Address</th>
                                                                      <th>Contact</th>
                                                                      <th <?php if ($_SESSION['ssrole']=='Admin' || $_SESSION['ssrole']=='Alumni') {
                                                                            echo "style='visibility:hidden;'";
                                                                        } ?>>Actions</th>
                                                                    </tr>
                                                                  </thead>
                                                                  ...
                                                                  <tbody>
                                                                    <?php $admin = new admin(); $admin->display(); ?>
                                                                  </tbody>
                                                                </table>
                                                            </div>
                                                            </div>
                                    ...
                                    <div class="product-tab-list tab-pane fade in" id="representative">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div class="row">
